...
After downloading, organize the dataset as shown in the following project structure.

📂 Project Structure
knnassignment/
├─ src/
│  └─ knn.py                     # Main KNN experiment script
├─ data/                         # Here goes the CIFAR-10
│  ├─ train/                     # Training images (id.png)
│  ├─ test/                      # Test images (id.png)
│  ├─ trainLabels.csv            # Image labels
│  └─ sampleSubmission.csv
├─ results/                      # Output metrics and plots (auto-generated)
